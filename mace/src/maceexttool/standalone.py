...
def run(arglist: list[str]):
    """Run the MACE calculation on a given structure using a specified model file."""
    ...
    # run MACE calculator
    energy, gradient = run_mace(atom_types=atom_types, coordinates=coordinates, charge=charge, mult=mult,
